...
Feature: LMS.Answer problems
    ...
    Scenario: I can view and hide the answer if the problem has it:
        ...
        When I press the button with the label "Show Answers"
        Then the Show/Hide button label is "Hide Answers"
        And I should see "4.14159" somewhere in the page
        When I press the button with the label "Hide Answers"
        Then the Show/Hide button label is "Show Answers"
